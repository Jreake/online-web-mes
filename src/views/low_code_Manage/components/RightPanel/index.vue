                    ...
                    <el-form-item
                        v-if="
                            activeData.size !== undefined &&
                                (activeData.__config__.optionType ===
                                    'button' ||
...
import TreeNodeDialog from './components/TreeNodeDialog/index'
import { isNumberStr } from '@/utils/lowCode/index'
import IconsDialog from './components/IconsDialog/index'
import {
    inputComponents, selectComponents, layoutComponents
} from './../generator/config'
import { saveFormConf } from '@/utils/lowCode/db'
