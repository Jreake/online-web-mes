...
import { exportDefault, beautifierConf, titleCase } from '@/utils/lowCode/index'
import ResourceDialog from './components/ResourceDialog/index'
import loadMonaco from '@/utils/lowCode/loadMonaco'
import loadBeautifier from '@/utils/lowCode/loadBeautifier'
