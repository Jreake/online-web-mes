	...
	<div class="theme-page">
		<div class="content">
			<div class="fix-color-pick">
				<el-space>
					<el-button size="mini" type="primary" @click="resetTheme"
						>重置</el-button
					>
					<el-color-picker
						v-model="color"
			...
			<el-space wrap>
				<el-card>
					<el-space class="flex center">
						<el-button type="primary" @click="handleNprogress(true)"
							>开始nprogress</el-button
						>
						<el-button type="info" @click="handleNprogress(false)"
							>结束nprogress</el-button
						>
					</el-space>
				</el-card>
				<el-card>
